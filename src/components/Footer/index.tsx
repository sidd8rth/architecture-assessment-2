...
const FOOTER_LINKS = [
  { label: 'Terms & Conditions', href: 'https://www.airtel.in/mobile/terms-conditions?icid=footer' },
  { label: 'Privacy Policy',     href: 'https://www.airtel.in/privacy-policy/' },
  { label: 'Cookie Notice',      href: 'https://www.airtel.in/cookie-notice/' },
  { label: 'Contact Us',         href: 'https://www.airtel.in/contact-us/?icid=footer' },
]
  ...
  return (
    <footer className="bg-white border-t border-[#E5E5E5] mt-auto">
      <div className="max-w-6xl mx-auto px-6 py-3">
        ...
        <div className="mt-3 pt-3 border-t border-[#F0F0F0] text-xs text-gray-400">
